...
**[R – Installation of R and RStudio, setting the working directory \[YouTube\]](https://youtu.be/fnpchOccshE)**

## **Lesson 2: R Basics**

**[R projects, scripts, objects, variables, dataset, list](https://rpubs.com/kamrulext/ms-phd-l1) \[[Supplements](https://rpubs.com/kamrulext/lesson2)\]**

## **Lesson 3: Visualizations**

[**R markdown, Basic functions, Package (tidyverse) installation, Visualization using ggplot()**](/courses/lessons-data-analysis-r/Descriptives-chi-sqaure.qmd) **\[[YouTube](https://youtu.be/1SlzQnSiebU)\]**

## **Lesson 4: Data manipulation**

[**Dataset manipulation, Pareto chart, Chi-square test**](https://rpubs.com/kamrulext/lesson4) **\[[YouTube](https://www.youtube.com/watch?v=li085_Ld5vc)\] \[[Supplements](https://rpubs.com/kamrulext/lesson4supplements)\]**

## **Lesson 5: Descriptives**

[**Descriptive statistics and chi-square test revisit**](https://rpubs.com/kamrulext/lesson5) **\[[YouTube](https://www.youtube.com/watch?v=kAy_wQrqW1E)\]**

## **Lesson 6: Confidence interval**

[**CLT, Standard error, Confidence interval**](https://rpubs.com/kamrulext/lesson6)

## **Lesson 7: One-sample t-tests**

[**One sample t-test, z-test**](https://rpubs.com/kamrulext/lesson789)

## **Lesson 8: Two sample t-test**

[**Two sample t-test (independent and paired)**](https://rpubs.com/kamrulext/lesson789)

## **Lesson 9: Non-parametric mean comparison**

[**Mann-Whitney test (independent) and Wilcoxon test (dependent)**](https://rpubs.com/kamrulext/lesson789)

## **Lesson 10: ANOVA**

**ANOVA ([one-way](https://rpubs.com/kamrulext/anova1), [two-way](https://rpubs.com/kamrulext/anova2), [three-way for CRD, RCBD and Factorial design](https://rpubs.com/kamrulext/anova3))**

## **Lesson 11: ANOVA for Split-plots**

[**ANOVA (mixed effects for split-plot design)**](https://rpubs.com/kamrulext/anova4) **\[[Supplement](https://rpubs.com/kamrulext/mixed1)\]**

## **Lesson 12: ANOVA post-hoc**

[**Residual and Post-hoc analysis**](https://rpubs.com/kamrulext/anova3)

## **Lesson 13: Non-parametric ANOVA**

[**Kruskal-Wallis test**](https://rpubs.com/kamrulext/kruskal)

## **Lesson 14: Correlation**

[**Correlation (Spearman and Pearson)**](https://rpubs.com/kamrulext/correlation)

## **Lesson 15: Linear regression**

[**Linear simple and multiple regression**](https://rpubs.com/kamrulext/linear_regression)

## **Lesson 16: Logistic regression**

[**Logistic regression**](https://rpubs.com/kamrulext/logit)
