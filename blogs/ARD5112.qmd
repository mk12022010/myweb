...
3. **Deductive order** - general to specific (e.g. role of communication -> technology adoption)
4. **Inductive order** - specific to general (e.g. impact of compost use -> role of compost in soil fertility)
...
- Limiting disfavourable parts suitable for illiterate audience. Example: Family planning helps welfare (favourable) but may contradict social tradition (disfavourable)
...
- This is something like finding one's weak (extreme affinity) points and directing the message encompassing that side.
...
- Emotional and rational appeals are often complementary
- Emotional for less educated; rational for elite/educated voters
...
## Communication methods, channels and aids {.smaller2}
...
> Communication types linked to methods, channels and aids [@ray2003]. Note: These are sometimes overlapping and the distiction is fuzzy and blurred. Consider their position and way of use. 
...
> **Q. How will you evaluate the success of this communication strategy?**
...
1. Socio-demographic and economic characteristics, including education, experience, income level, social interaction intensity
2. Media choice
3. Language barriers
4. Audience attitude
5. Audience need
...
graph LR
    ...
    %% Apply a large font size safely to all nodes
    classDef largeFont font-size:24px;
    class A,B,C,D,E,F,G largeFont;
```
...
- [https://www.fao.org/research-extension-systems/ais/en/](https://www.fao.org/research-extension-systems/ais/en/)
- [https://cd4ais.ifpri.info/what-is-an-agricultural-innovation-system/](https://cd4ais.ifpri.info/what-is-an-agricultural-innovation-system/)
- [https://www.oecd.org/content/dam/oecd/en/publications/reports/2013/06/agricultural-innovation-systems_g1g2ec7d/9789264200593-en.pdf](https://www.oecd.org/content/dam/oecd/en/publications/reports/2013/06/agricultural-innovation-systems_g1g2ec7d/9789264200593-en.pdf)


## Agricultural Innovation System

<div style="text-align: center;">
  <img src="images/innovation-system.png" alt="Agricultural Innovation System" />
</div>


## Agricultural Innovation Dynamics

<div style="text-align: center;">
  <img src="images/innovation-dynamics.png" alt="Innovation dynamics" />
</div>
