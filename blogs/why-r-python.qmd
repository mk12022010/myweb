...
`{
    ...
    "r.rpath.windows": "C:\\Program Files\\R\\R-X.X.XVer----si----on\\bin\\x64\\R.exe",
    ...
    // For diasabling lints
    "r.lsp.diagnostics": false, 

    // For using Radian R consol use the following
    "r.rterm.windows": "C:\\Users\\XXXXXU--------s-----e------r\\AppData\\Local\\Programs\\Python\\PythonXXXVe----rs----ion\\Scripts\\radian.exe",
    "breadcrumbs.enabled": false,

    
    // For using using the original R Console (instead of radian) use the following settings.
    // "terminal.integrated.profiles.windows": {
    
    //     "R Terminal": {
    //     "path": "C:\\Program Files\\R\\R-X.X.XVer----si----on\\bin\\R.exe",
